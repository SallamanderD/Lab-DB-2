...
namespace Hostel {
    ...
    public partial class HostelDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentsDataTable : global::System.Data.TypedTableBase<StudentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentsRow AddStudentsRow(int Id, string Name, string Gender, string Address, string Group, string Passport, BenefitsRow parentBenefitsRowByFK_Table_ToTable, RoomsRow parentRoomsRowByFK_Table_ToTable_1, System.DateTime ColonizeDate) {
                ...
                object[] columnValuesArray = new object[] {
                        ...
                        null,
                        ColonizeDate};
                if ((parentBenefitsRowByFK_Table_ToTable != null)) {
                    columnValuesArray[6] = parentBenefitsRowByFK_Table_ToTable[0];
                }
                if ((parentRoomsRowByFK_Table_ToTable_1 != null)) {
                    columnValuesArray[7] = parentRoomsRowByFK_Table_ToTable_1[0];
                }
        ...
        public partial class BenefitsRow : global::System.Data.DataRow {
            ...
            public StudentsRow[] GetStudentsRows() {
                if ((this.Table.ChildRelations["FK_Table_ToTable"] == null)) {
                    ...
                    return ((StudentsRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Table_ToTable"])));
                }
            }
        }
        ...
        public partial class RoomsRow : global::System.Data.DataRow {
            ...
            public StudentsRow[] GetStudentsRows() {
                if ((this.Table.ChildRelations["FK_Table_ToTable_1"] == null)) {
                    ...
                    return ((StudentsRow[])(base.GetChildRows(this.Table.ChildRelations["FK_Table_ToTable_1"])));
                }
            }
        }
        ...
        public partial class StudentsRow : global::System.Data.DataRow {
            ...
            public BenefitsRow BenefitsRow {
                get {
                    return ((BenefitsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Table_ToTable"])));
                }
                set {
            ...
            public RoomsRow RoomsRow {
                get {
                    return ((RoomsRow)(this.GetParentRow(this.Table.ParentRelations["FK_Table_ToTable_1"])));
                }
                set {
...
SELECT Id, Price, Amount, Floor, Tools FROM Rooms WHERE (Id = @Id)";
    ...
    public partial class StudentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Students] ([Id], [Name], [Gender], [Address], [Group], [Passport], [BenefitCode], [RoomNumber], [ColonizeDate]) VALUES (@Id, @Name, @Gender, @Address, @Group, @Passport, @BenefitCode, @RoomNumber, @ColonizeDate);
...
SELECT Id, Name, Gender, Address, [Group], Passport, BenefitCode, RoomNumber, ColonizeDate FROM Students WHERE (Id = @Id)";
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(int Id, string Name, string Gender, string Address, string Group, string Passport, int BenefitCode, int RoomNumber, System.DateTime ColonizeDate) {
            this.Adapter.InsertCommand.Parameters[0].Value = ((int)(Id));
            if ((Name == null)) {
